<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 z-[10000000000] fixed right-0 left-0">
            ...
            <div class="flex">
                ...
                <div class="space-x-8 -my-px ml-1 flex items-center ">
                    <select class="select select-bordered bg-transparent text-gray-800 select-info w-44 max-w-xs">
                        ...
                        <option>{{ __('words.kuToen') }}</option> 
                        <option>{{ __('words.kuToar') }}</option>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            ...
                            <img class="rounded-[50px] h-10 w-10 " src="{{ Auth::user()->avatar }}" alt="">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dic.home')" :active="request()->routeIs('dic.home')">
                {{ __('Dashboard') }}
